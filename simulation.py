...
r_contagio=4  #radius of transmission in pixels (0-100)
p_contagio=5  #probability of transmission in percentage (0-100%)
p_aislamiento = 0  #percentage of the people in quarantine (0-100%)
